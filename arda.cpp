...
// Determine whether a directory contains entries other than '.' and '..'.
// dir: path to the directory to inspect.
// returns true if the directory has at least one such entry.
...
// Check whether a path refers to an existing filesystem object.
// path: file path to check.
// returns true if stat succeeds for the given path.
...
// Validate the database directory structure and required files.
// path: path to the database (relative paths expand from HOME).
...
// Program entry point (unused stub).
int main() {
